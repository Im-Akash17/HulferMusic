...
function Player() {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 p-5 shadow-lg bg-white">
      <div className="flex justify-between items-center border p-5 border-purple-300 rounded shadow-xl">
        <div className="flex items-center gap-2 w-96">
          <img
            className="h-20 w-32"
            src="https://img.freepik.com/free-vector/musical-notes-frame-with-text-space_1017-32857.jpg?w=1380&t=st=1700662822~exp=1700663422~hmac=d2c27d8ac69309535c181d1709a7ecddf992f596f1931209a3ade36c3f2e3646"
            alt=""
          />
          <div>
